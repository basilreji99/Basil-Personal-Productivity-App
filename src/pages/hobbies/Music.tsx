                        ...
                        return (
                          <div key={name} className="px-4 py-3">
                            ...
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="font-inter text-[10px] text-outline shrink-0">{count} artists · {genreTracks.length} songs</span>
                            </div>
                          ...
                          <div key={a.id} className="px-4 py-3">
                            ...
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              {artistTracks.length > 0 && (
                                <span className="font-inter text-[10px] text-outline">{artistTracks.length} song{artistTracks.length !== 1 ? 's' : ''}</span>
                              )}
