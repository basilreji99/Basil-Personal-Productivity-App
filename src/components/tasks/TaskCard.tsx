  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-3 right-8 opacity-40 hover:opacity-100 active:opacity-100 transition-opacity p-1 rounded-lg hover:bg-surface-container text-on-surface-variant"
      >
