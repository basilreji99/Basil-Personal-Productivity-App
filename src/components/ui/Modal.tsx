...
export default function Modal({ open, onClose, title, children, size = 'md', hideHeader = false, disableBackdropClose = false }: ModalProps) {
  ...
  return createPortal(
    <div
      ...
      onClick={(e) => !disableBackdropClose && e.target === overlayRef.current && onClose()}
    >
